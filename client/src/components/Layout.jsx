...
function Layout({ children }) {
  ...
  // Only show certain ads based on the route
  const showHeaderAd = location.pathname === '/';
  const showFooterAd = true; // Show on all pages
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <footer className="bg-white mt-8">
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
          {showFooterAd && <AdUnit slot="footer-ad-slot" />}
